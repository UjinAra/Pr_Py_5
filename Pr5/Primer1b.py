...
# Тут вариант человек против человека:
...
def input_dat(name):
    ...
    if x < 1 or x > 28:
        print("Выберите кол-во конфет от 1 до 28 конфет")
        input_dat(name)
    return x
...
if flag:
    print(f"На столе 2021 конфета. Первый ходит {player1}")
else:
    print(f"На столе 2021 конфета. Первый ходит {player2}")
